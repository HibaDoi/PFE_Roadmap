...
def XYlocation(camera_info_file,directory_path,file_path,img_width,img_height):
    ...
    for j in range(len(u)-4) :
        print("_____________4 images numero: ",j)
        ...
        for i in range(4):
            ...
            V=[]
            V2=[]
            # print("0000000000000000000000000000",target_entry)
            if target_entry:
                print("eeeeeeeeeeeeeeee")
                for j in range(len(data_xy)):
                    xx = target_entry['x']  # Assuming width is pitch for this example
                    yy = target_entry['y']  # Assuming height is yaw for this example
                    zz = target_entry['z']  # Assuming width is pitch for this example
        ...
        if not df_filtered.empty :
            print("_______________________Intersection Here_______________________")
