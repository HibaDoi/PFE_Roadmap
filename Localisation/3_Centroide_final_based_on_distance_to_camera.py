...
def more_filtering(input,output,output_shp,max_dist):
    ...
    # unique_count_cluster = df['cluster'].nunique()
    # print(unique_count_cluster)
    # unique_values_cluster = df['cluster'].unique()
    # print(unique_values_cluster)
